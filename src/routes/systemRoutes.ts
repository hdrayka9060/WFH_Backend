...
router.post('/list',ZodMiddleware.zodValidation(OrganisationListZodSchema),JwtMiddleware.jwtVerifySystemUser,SystemController.organisationList)
...
router.post('/users',ZodMiddleware.zodValidation(OrganisationUsersZodSchema),JwtMiddleware.jwtVerifySystemUser,SystemController.organisationUsers)
...
router.put('/delete',ZodMiddleware.zodValidation(DeleteOrganisationZodSchema),JwtMiddleware.jwtVerifySystemUser,SystemController.deleteOrganisation)
